...
def peptide_process(peptide):
    ...
    mod_dictg["amino"]=peptide[position]
    # print(mod_dictg["amino"])
...
def pepfragmass(input,mode,maxcharge=3):
    ...
    if "ETD" in mode: #ETD模式意味着，随着位置糖全部保留，然后碎裂肽段,ETD是cz碎裂注意一下
